...
const editContact = async () => {
  ...
  try {
    await contacts.editContact(route.params.id, form.value);
    if (contacts.editedContact) {
...
const fetchData = async () => {
  try {
    ...
    form.value.work_time = contacts.detailContact.data.work_time
    form.value.contact_items = contacts.detailContact.data.contact_items
    form.value.break = contacts.detailContact.data.break
  } catch (error) {
    console.error(error);
  }
};
  ...
  <div class="px-4 sm:px-6 lg:px-8">
    <div>
      ...
      <p class="text-sm mb-3">
        Заполните все поля для редактирования контакта.
      </p>
    </div>
        ...
        <div class="flex flex-col">
          <div>
            <div
              ...
              <p
                  class="w-[100px] min-w-[100px] text-sm">{{ days[index] }}</p>
              <div
        ...
        <div class="flex flex-col">
          <div>
            <div class="flex items-center gap-5">
              <div
                  :class="{ '!border !border-red-500 rounded-md' : v$.break.start_time.$error }"
                  class="w-1/3 rounded-md px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                <label
                    for="name"
                    class="block text-xs font-medium text-gray-900">
              ...
              <div
                  :class="{ '!border !border-red-500 rounded-md' : v$.break.end_time.$error }"
                  class="w-1/3 rounded-md px-3 pb-1.5 pt-2.5 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
                <label
                    for="name"
                    class="block text-xs font-medium text-gray-900">
